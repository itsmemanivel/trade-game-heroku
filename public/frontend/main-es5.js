...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["main"], {
        ...
        /***/
            ...
            var _directive_count_down_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
                /*! ./directive/count-down.directive */
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _game_game_component__WEBPACK_IMPORTED_MODULE_5__["GameComponent"], _directive_count_down_directive__WEBPACK_IMPORTED_MODULE_6__["CountDownDirective"], _login_login_component__WEBPACK_IMPORTED_MODULE_9__["LoginComponent"]],
                imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_material__WEBPACK_IMPORTED_MODULE_12__["MatTableModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_11__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_12__["MatIconModule"]],
        ...
        /***/
            function srcAppDirectiveCountDownDirectiveTs(module, __webpack_exports__, __webpack_require__) {
            "use strict";
            ...
            __webpack_require__.d(__webpack_exports__, "CountDownDirective", function() {
            ...
            var CountDownDirective = /*#__PURE__*/ function() {
                function CountDownDirective() {
                    var _this = this;

                    _classCallCheck(this, CountDownDirective);
                    ...
                    this._subscription = this._counterSource$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function(_ref) {
                        var interval = _ref.interval,
                            count = _ref.count;
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(0, interval).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(count), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function() {
                            return _this.value.emit(--count);
                        }));
                    })).subscribe();
                }

                _createClass(CountDownDirective, [{
                    key: "ngOnChanges",
            ...
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CountDownDirective.prototype, "counter", void 0);
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], CountDownDirective.prototype, "interval", void 0);
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], CountDownDirective.prototype, "value", void 0);
            CountDownDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Directive"])({
                selector: '[counter]'
            })], CountDownDirective);
            /***/
        },
        ...
        /***/
            ...
            var GameComponent = /*#__PURE__*/ function() {
                function GameComponent(service, authService, router) {
                ...
                _createClass(GameComponent, [{
                    ...
                    value: function getRecords() {
                        ...
                        this.service.getRecords().subscribe(function(res) {
                            // console.log(res);
                            // var records:any = res.data;
                            _this3.records = res.data; // console.log(this.records);

                            _this3.currentPeriod = res.data[0].period + 1;
                        });
                    }
                }, {
                    key: "getTimer",
                    value: function getTimer() {
                        ...
                        this.service.getTimer().subscribe(function(res) {
                            // console.log(res);
                            _this4.getBalance();

                            _this4.minutes = res.mins;
                            _this4.seconds = res.secs;

                            if (_this4.minutes == '00' && _this4.seconds <= '30') {
                                _this4.result = true;
                            ...
                            if (_this4.minutes == '00' && _this4.seconds <= '25') {
                                _this4.choosedValue();
                    ...
                    value: function getBalance() {
                        ...
                        this.service.getPayments(this.userID).subscribe(function(res) {
                            _this5.accountBalance = res.data.amount; // console.log(this.accountBalance);

                            _this5.updateBalance = res.data.amount;
                        });
                    }
                }, {
                    key: "btnClicked",
                    value: function btnClicked(value) {
                        console.log(value);
                        localStorage.setItem("choosed", value);
                    }
                }, {
                    key: "choosedValue",
                    value: function choosedValue() {
                        var value = localStorage.getItem("choosed"); // if(this.records[0].result == "odd"  && (value == "green")){
                        //   console.log('HI')
                        // }
                        ...
                        if (value != null) {
                            if (this.records[0].number == value) {
                                var amount = this.updateBalance * 9; // console.log(amount);

                                this.service.updatePayments(this.userID, amount).subscribe(function(res) {
                                ...
                                // console.log(98*1.5);
                                var amount = this.updateBalance * 1.5; // console.log(amount);
                                ...
                                // console.log(98*4.5);
                                var amount = this.updateBalance * 4.5; // console.log(amount);
            ...
            var LoginComponent = /*#__PURE__*/ function() {
                ...
                _createClass(LoginComponent, [{
                    ...
                    value: function login(username, password) {
                        ...
                        this.authService.login(username).subscribe(function(res) {
                            if (res.data != null && res.data.password == password) {
                                _this6.success = 1;

                                _this6.route.navigate(['game']);
            ...
            var AuthService = /*#__PURE__*/ function() {
                ...
                _createClass(AuthService, [{
                    ...
                    value: function login(username) {
                        ...
                        return this.http.post(this.URL + 'users/getbyID/', body, this.headers).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function(data) {
                            localStorage.setItem('currentUser', JSON.stringify(data.data));

                            _this7.currentUserSubject.next(data.data); //  window.location.reload();
        ...
        /***/
            ...
            var BackendService = /*#__PURE__*/ function() {
                ...
                _createClass(BackendService, [{
                    ...
                    key: "updatePayments",
                    value: function updatePayments(userID, amount) {
                        var body = {
                            userID: userID,
                            amount: amount
                        };
        ...
        /***/
            ...
            module.exports = __webpack_require__(
                /*! /home/veluvijay/projects/trade-game/frontend/src/main.ts */
                "./src/main.ts");
            /***/
        }
    },
